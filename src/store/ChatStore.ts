...
class ChatStore {
  ...
  public messages: ChatMessageType[] = [
    ...
    { id: 412759, author: "Глеб Губкин", text: "Lorem Ipsum является текст-заполнитель @mental обычно используется в графических, печать и издательской индустрии для предварительного просмотра макета и визуальных макетах." },
